function Display_Instructions(ListNumberInstructions,EncodingInstruction,WhichColor,path,window,FontSizeInstruct)
...
for InstructionNumber= 1:length(ListNumberInstructions)
    ...
    TempInstructionFile = fopen([path 'Instruction_' num2str(ListNumberInstructions(InstructionNumber)) '.txt'],'r+','n',EncodingInstruction);
