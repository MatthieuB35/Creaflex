function Output=AskingInstructions(Question,Encoding,WhichColor,path,window)
...
TempInstructionFile = fopen([path '/TAC_Instr/Instruction_' num2str(Question) '.txt'],'r+','n',Encoding);
