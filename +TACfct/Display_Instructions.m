function Display_Instructions(ListNumberInstructions,EncodingInstruction,WhichColor,path,window)
...
for InstructionNumber= 1:length(ListNumberInstructions)
    ...
    TempInstructionFile = fopen([path '/TAC_Instr/Instruction_' num2str(ListNumberInstructions(InstructionNumber)) '.txt'],'r+','n',EncodingInstruction);
