...
for WhichIterationTraining = 1:NumberItems
    ...
    [~, ~, textBounds]=DrawFormattedText(window,textString_Left_CurrIt,LeftScreenPosition, rect(4)*(scalaPosition*CuesPositionYChg),NormalColor); %Left item
    ...
    DrawFormattedText(window, textString_Left_CurrIt,LeftScreenPosition-DisplaceText, rect(4)*(scalaPosition*CuesPositionYChg),NormalColor);
    DrawFormattedText(window, textString_Right_CurrIt,RightScreenPosition, rect(4)*(scalaPosition*CuesPositionYChg),NormalColor);
